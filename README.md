...
├── .agents/skills/                    # Legacy Danish job portal CLI tools (reference only)
│   ├── jobbank-search/                # Akademikernes Jobbank (legacy)
│   ├── jobdanmark-search/             # Jobdanmark.dk (legacy)
│   ├── jobindex-search/               # Jobindex.dk (legacy)
│   └── jobnet-search/                 # Jobnet.dk (legacy)
├── cv/
